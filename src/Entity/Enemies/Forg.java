...
public class Forg extends Enemy {
	...
	public Forg(TileMap tm, Player p, ArrayList<Enemy> en) {
		...
		idleSprites = Content.Forg[0];
		jumpSprites = Content.Forg[0];
		attackSprites = Content.Forg[0];
