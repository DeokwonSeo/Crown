...
public class Boss1_State extends GameState {
	...
	public Boss1_State(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void init() {
		...
		cave = new Background("/Backgrounds/back_cave.png", 0.1);

		
		// tilemap
		tileMap = new TileMap(30);
		tileMap.loadTiles("/Tilesets/Stage1_tiles.png");
		tileMap.loadMap("/Maps/Boss1.map");
		tileMap.setPosition(20, 0);
		
		tileMap.setTween(1);
		// teleport
				teleport = new Teleport(tileMap);
				teleport.setPosition(434, 286);
				teleport.setPosition(5054, 136);
		// player
		player = new Player(tileMap);
		player.setPosition(135, 345);
	...
	public void update() {
		...
		// move backgrounds
		cave.setPosition(tileMap.getx(), tileMap.gety());
